...
- Create Angular project with ng: `ng new contavida.mvc.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`contavida.mvc.client.esproj`).
